...
# of this song, Polycarpus inserts a certain number of words "WUB" before the first word of the song (the number
# may be zero), after the last word (the number may be zero), and between words (at least one between any pair 
# of neighbouring words), and then the boy glues together all the words, including "WUB", in one string and plays 
...
def song_decoder(song)
  original_song = song.split(/WUB/)
  original_song.delete('')
  original_song.join(' ')
end
