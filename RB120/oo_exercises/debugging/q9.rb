...
- This is a case of method overriding and not including the module within our class
- We don't get a NoMethodError saying because ruby did actually find a send method within the Object class
- The send method in the Object class expects a method name as its argument, which was not provided
- We therefore need to inclucde the mailing module in the PostalService class and change the name of the send
  method to avoid any overriding of the send method in the Object class
